<?php
$php_ary = array(
  "缺乏運動已成為影響全球死亡率的第四大危險因子" => "資料來源： 行政院衛生署國民健康局 
發佈日期： 2012 / 10 / 07
...
7. 減少看電視、打電玩等靜態生活的時間。
    民眾對運動如有疑問，可參考國民健康局肥胖防治網-「快樂動」(http://obesity.bhp.gov.tw)，亦可撥打免費市話健康體重管理電話諮",
  "菸害防治法規" => "第二十三條　　違反第五條或第十條第一項規定者，處新臺幣一萬元以上五萬元以下罰鍰，並得按次連續處罰。
...
第三十三條　　本法所定罰則，除第二十五條規定由中央主管機關處罰外，由直轄市、縣（市）主管機關處罰之。",
  "降低罹癌風險" => "癌症防治   三管齊下  Part 1 降低罹癌風險建構健康生活型態 
...
資料來源：行政院衛生署衛生報導139期
上稿日期：2010/1/20",
  "長期憋尿 泌尿系統問題多" => "資料來源：中央健康保險局雙月刊第98期
上稿日期：2012/08/10
文／游小雯
...
<body>
  ...
  <script>
    ...
    $(".sswww").hover(function(){
      ...
      let divtop=$(this).offset().top+25;
      $("#alt").text(txt).css("top",divtop).show();
    });
